<x-app-layout layout="dualhorizontal" :assets="$assets ?? []" :isBanner="false" :isSidebar="false" :isNavbar="false" :isSelect2="true" :isFlatpickr="true" active="dual-horizontal">
                            ...
                            <div>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div class="progress bg-info-subtle shadow-none w-100" style="height: 5.9px">
                        ...
                        <div class="col-md-6">
                            <div class="iq-scroller-effect">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <a href="#" class="badge rounded-pill bg-primary-subtle">
                                        All Contacts
                                    </a>
                                </div>
                                <div class="d-flex align-items-center iq-slider mb-4 gap-2">
                                    <div>
                                        <img class="rounded-circle bg-primary-subtle img-fluid avatar-40 mb-2" src="{{ asset('images/table/1.png') }}" alt="profile" loading="lazy" />
                                    </div>
                                    <div>
                                        <img class="rounded-circle bg-primary-subtle img-fluid avatar-40 mb-2" src="{{ asset('images/table/2.png') }}" alt="profile" loading="lazy" />
                                    </div>
                                    <div>
                                        <img class="rounded-circle bg-primary-subtle img-fluid avatar-40 mb-2" src="{{ asset('images/table/3.png') }}" alt="profile" loading="lazy" />
                                    </div>
                                    <div>
                                        <img class="rounded-circle bg-primary-subtle img-fluid avatar-40 mb-2" src="{{ asset('images/table/4.png') }}" alt="profile" loading="lazy" />
                                    </div>
                                    <div>
                                        <img class="rounded-circle bg-primary-subtle img-fluid avatar-40 mb-2" src="{{ asset('images/table/5.png') }}" alt="profile" loading="lazy" />
                                    </div>
                                </div>
                                <div>
