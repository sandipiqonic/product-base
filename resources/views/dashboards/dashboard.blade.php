<x-app-layout :assets="$assets ?? []" title="Home" isSelect2="true" isTour="true" isFlatpickr="true" :isSidebar="true"
                        ...
                        <div class="col-md-6">
                            <div class="iq-scroller-effect">
                                ...
                                <div class="d-flex align-items-center iq-slider mb-5 gap-2">
                                    <div>
                                        <img class="rounded-circle bg-primary-subtle img-fluid avatar-40 mb-2"
                                            src="{{ asset('images/table/1.png') }}" alt="profile" loading="lazy" />
                                    </div>
                                    <div>
                                        <img class="rounded-circle bg-primary-subtle img-fluid avatar-40 mb-2"
                                            src="{{ asset('images/table/2.png') }}" alt="profile" loading="lazy" />
                                    </div>
                                    <div>
                                        <img class="rounded-circle bg-primary-subtle img-fluid avatar-40 mb-2"
                                            src="{{ asset('images/table/3.png') }}" alt="profile" loading="lazy" />
                                    </div>
                                    <div>
                                        <img class="rounded-circle bg-primary-subtle img-fluid avatar-40 mb-2"
                                            src="{{ asset('images/table/4.png') }}" alt="profile" loading="lazy" />
                                    </div>
                                    <div>
                                        <img class="rounded-circle bg-primary-subtle img-fluid avatar-40 mb-2"
                                            src="{{ asset('images/table/5.png') }}" alt="profile" loading="lazy" />
                                    </div>
                                </div>
                                <div>
