                     ...
                     <table id="basic-table" class="table table-striped mb-0" role="grid">
                        ...
                        <tbody>
                           <tr>
                              <td>
                                 <div class="d-flex align-items-center">
                                    <img class="bg-primary-subtle rounded img-fluid avatar-40 me-3" src="{{asset('images/shapes/01.png')}}" alt="profile">
                              ...
                              <td>
                                 ...
                                 <div class="progress bg-primary-subtle shadow-none w-100" style="height: 4px">
                           ...
                           <tr>
                              <td>
                                 <div class="d-flex align-items-center">
                                    <img class="bg-primary-subtle rounded img-fluid avatar-40 me-3" src="{{asset('images/shapes/05.png')}}" alt="profile">
                           ...
                           <tr>
                              <td>
                                 <div class="d-flex align-items-center">
                                    <img class="bg-primary-subtle rounded img-fluid avatar-40 me-3" src="{{asset('images/shapes/02.png')}}" alt="profile">
                           ...
                           <tr>
                              <td>
                                 <div class="d-flex align-items-center">
                                    <img class="bg-primary-subtle rounded img-fluid avatar-40 me-3" src="{{asset('images/shapes/03.png')}}" alt="profile">
                           ...
                           <tr>
                              <td>
                                 <div class="d-flex align-items-center">
                                    <img class="bg-primary-subtle rounded img-fluid avatar-40 me-3" src="{{asset('images/shapes/04.png')}}" alt="profile">
