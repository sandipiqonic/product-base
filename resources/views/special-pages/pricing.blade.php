            ...
            <div class="col">
               <div class="card mb-4 rounded-3 ">
                  <div class="card-body">
                     ...
                     <button type="button" class="btn btn-outline-gray disabled">Sign up for free</button>
                  </div>
               </div>
            </div>
            <div class="col">
                  ...
                  <div class="card-body p-0">
                     <div class="table-responsive pricing pt-2">
                        <table class="table table-bordered mb-0">
                                 ...
                                 <th>
                                    <div>
                                       <div class="d-flex align-items-center">
                                          ...
                                          <span class="badge rounded-pill bg-success-subtle ms-2">Popular</span>
                                       </div>
                                       <div class="d-flex justify-content-start align-items-center mt-4">
                                          <small>USD</small>
                                          <h4 class="mx-2">$15</h4>
                           ...
                           <tbody>
                              <tr>
                                 <th colspan="5" class="bg-primary-subtle">Features</th>
                              </tr>
                              <tr>
                                 <th scope="row">Features 1</th>
                              ...
                              <tr>
                                 <th colspan="5" class="bg-primary-subtle">Payment</th>
                              </tr>
                              <tr>
                ...
                <div class="row no-gutters">
                   ...
                   <div class="col-md-4">
                      <div class="card-body text-center h-100 iq-single-card">
                         ...
                         <button class="btn btn-primary rounded-pill mt-4 w-100">Get Started</button>
                      </div>
                   </div>
                </div>
             </div>
         ...
         <div class="row iq-star-inserted row-cols-1 row-cols-md-2 row-cols-lg-3 mb-4 mt-4 text-center">
            ...
            <div class="col iq-star-inserted-2">
               <div class="card mb-0 shadow-lg">
                  <div class="card-body">
                     <h2><span class="badge rounded-pill bg-primary-subtle mb-4"><small class="text-uppercase px-3">Popular</small></span></h2>
