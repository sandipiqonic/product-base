<x-app-layout layout="landing">
    <div class="banner-one-app">
        <div class="container">
            <div class="row">
                <div class="banner-one-img col-sm-6 text-center ms-2 ms-sm-0">
                    <img src="{{ asset('images/landing-pages/images/home-1/banner-top.png') }}" alt=""
                        class="img-fluid ">
                </div>
                <div class="col-sm-6 inner-box">
                    ...
                    <div class="d-flex align-items-center store-btn">
                        ...
                        <a hrer="javascript" class="btn btn-secondary ms-3">Buy Pro</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row mx-2 mx-sm-0">
                ...
                <div class="col-lg-6 top-feature">
                    <div class="text-right">
                        ...
                        <h2 class="mb-3 text-white notch-feature-txt">Top Notch sdsdFeatures </h2>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="d-flex align-items-center store-btn flex-wrap">
                        <img src="{{ asset('images/landing-pages/images/home-1/playstore.webp') }}" alt=""
                            class="img-fluid  mb-md-0 mb-sm-2 me-3 mb-2">
                        <img src="{{ asset('images/landing-pages/images/home-1/appstore.png') }}" alt=""
                            class="img-fluid  ms-sm-0 mb-2 mb-md-0">
                    </div>
                </div>
    ...
    <div class="section-padding ">
        <div class="container">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3">
                <div class="col">
                    <img src="{{ asset('images/landing-pages/images/home-1/01.png') }}" alt=""
                        class="img-fluid ">
                </div>
                <div class="col">
                    <img src="{{ asset('images/landing-pages/images/home-1/02.png') }}" alt=""
                        class="img-fluid ">
                </div>
                <div class="col">
                    <img src="{{ asset('images/landing-pages/images/home-1/03.png') }}" alt=""
                        class="img-fluid ">
                </div>
            </div>
        </div>
    ...
    <div class="section-card-padding bg-white">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-3 col-sm-3">
                    <div class="card team-image">
                        <x-landing-pages.widgets.team teamImage="team-3.jpg" teamTitle="Arlene McCoy"
                            teamText="Researcher" />
                    </div>
                </div>
                <div class="col-md-3 col-sm-3">
                ...
                <div class="overflow-hidden slider-circle-btn mt-5" id="app-slider">
                    <ul class="p-0 m-0 swiper-wrapper list-inline">
                        <li class="swiper-slide card card-slide card overflow-hidden">
                            <x-landing-pages.widgets.blog blogImage="home-1/04.png"
                                blogTitle="The Shaping the futures, part by part." blogText="Video" />
                        </li>
                        <li class="swiper-slide card card-slide card overflow-hidden">
                            <x-landing-pages.widgets.blog blogImage="home-1/05.png"
                                blogTitle="Technology that unwinds your potential." blogText="Video" />
                        </li>
                        <li class="swiper-slide card card-slide card overflow-hidden">
                            <x-landing-pages.widgets.blog blogImage="home-1/06.png"
