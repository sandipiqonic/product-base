            ...
            <div class="card">
               ...
               <div class="card-body">
                     ...
                     <div class="form-group">
                        ...
                        {{Form::select('user_role', $roles , old('user_role') ? old('user_role') : $data->user_type ?? 'user', ['class' => 'form-control', 'placeholder' => 'Select'])}}
                     </div>
                     <div class="form-group">
                  ...
                  <div class="new-user-info">
                        <div class="row">
                           ...
                           <div class="form-group col-md-6">
                              ...
                              {{ Form::text('userProfile[street_addr_1]', old('userProfile[street_addr_1]'), ['class' => 'form-control', 'id' => 'add1', 'placeholder' => 'Street Address 1']) }}
                           </div>
                           <div class="form-group col-md-6">
                              <label class="form-label" for="add2">Street Address 2:</label>
                              {{ Form::text('userProfile[street_addr_2]', old('userProfile[street_addr_2]'), ['class' => 'form-control', 'id' => 'add2', 'placeholder' => 'Street Address 2']) }}
                           </div>
                           ...
                           <div class="form-group col-sm-12">
                              ...
                              {{ Form::text('userProfile[country]', old('userProfile[country]'), ['class' => 'form-control', 'id' => 'country' ,'placeholder'=>'Select Country']) }}
                           ...
                           <div class="form-group col-md-6">
                              ...
                              {{ Form::number('userProfile[pin_code]', old('userProfile[pin_code]'), ['class' => 'form-control', 'id' => 'pin_code','step' => 'any' ,'placeholder' => 'Pin Code']) }}
                           </div>
                           <div class="form-group col-md-12">
                              <label class="form-label" for="city">Town/City:</label>
                              {{ Form::text('userProfile[city]', old('city'), ['class' => 'form-control', 'id' => 'city', 'placeholder' => 'Town/City']) }}
                           </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                           <div class="form-group col-md-12">
                              ...
                              {{ Form::text('username', old('username'), ['class' => 'form-control', 'required', 'placeholder' => 'User Name']) }}
                           </div>
                           <div class="form-group col-md-6">
                        ...
                        <button type="submit" class="btn btn-primary">{{$id !== null ? 'Update' : 'Add' }} New User</button>
                  </div>
               </div>
            </div>
         </div>
