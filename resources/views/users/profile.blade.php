<x-app-layout :assets="$assets ?? []" title='User Profile' isBanner="true" isFslightbox="true">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                ...
                <div class="card-body">
                    <div class="d-grid gap-card grid-cols-3">
                        <a data-fslightbox="gallery" href="{{ asset('images/icons/04.png') }}">
                            <img src="{{ asset('images/icons/04.png') }}" class="img-fluid bg-info-subtle rounded"
                                alt="profile-image">
                        </a>
                        <a data-fslightbox="gallery" href="{{ asset('images/shapes/02.png') }}">
                            <img src="{{ asset('images/shapes/02.png') }}" class="img-fluid bg-primary-subtle rounded"
                                alt="profile-image">
                        </a>
                        <a data-fslightbox="gallery" href="{{ asset('images/icons/08.png') }}">
                            <img src="{{ asset('images/icons/08.png') }}" class="img-fluid bg-info-subtle rounded"
                                alt="profile-image">
                        </a>
                        ...
                        <a data-fslightbox="gallery" href="{{ asset('images/icons/02.png') }}">
                            <img src="{{ asset('images/icons/02.png') }}" class="img-fluid bg-warning-subtle rounded"
                                alt="profile-image">
                        </a>
                        ...
                        <a data-fslightbox="gallery" href="{{ asset('images/icons/05.png') }}">
                            <img src="{{ asset('images/icons/05.png') }}" class="img-fluid bg-danger-subtle rounded"
                                alt="profile-image">
                        </a>
                        <a data-fslightbox="gallery" href="{{ asset('images/shapes/04.png') }}">
                            <img src="{{ asset('images/shapes/04.png') }}"
                        ...
                        <a data-fslightbox="gallery" href="{{ asset('images/icons/01.png') }}">
                            <img src="{{ asset('images/icons/01.png') }}" class="img-fluid bg-success-subtle rounded"
                                alt="profile-image">
                        </a>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="twit-feed">
                        <div class="d-flex align-items-center mb-2">
                            <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-danger-subtle ps-2"
                    ...
                    <div class="twit-feed">
                        <div class="d-flex align-items-center mb-2">
                            <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-primary-subtle"
                    ...
                    <div class="twit-feed">
                        <div class="d-flex align-items-center mb-2">
                            <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-warning-subtle pt-2"
                            ...
                            <div class="header-title">
                                <div class="d-flex flex-wrap">
                                    <div class="media-support-user-img me-3">
                                        <img class="rounded-pill img-fluid avatar-60 bg-danger-subtle p-1 ps-2"
                                    ...
                                    <li class="mb-2">
                                        <div class="d-flex">
                                            <img src="{{ asset('images/avatars/03.png') }}" alt="userimg"
                                                class="avatar-50 p-1 pt-2 bg-primary-subtle rounded-pill img-fluid">
                                            <div class="ms-3">
                                    ...
                                    <li>
                                        <div class="d-flex">
                                            <img src="{{ asset('images/avatars/04.png') }}" alt="userimg"
                                                class="avatar-50 p-1 bg-danger-subtle rounded-pill img-fluid">
                                            <div class="ms-3">
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between pb-4">
                            <div class="header-title">
                                <div class="d-flex flex-wrap">
                                    <div class="media-support-user-img me-3">
                                        <img class="rounded-pill img-fluid avatar-60 p-1 bg-info-subtle"
                    ...
                    <ul class="list-inline m-0 p-0">
                        <li class="d-flex mb-4 align-items-center active">
                            <img src="{{ asset('images/icons/06.png') }}" alt="story-img"
                                class="rounded-pill avatar-70 p-1 border bg-light-subtle img-fluid">
                            <div class="ms-3">
                                <h5>Web Design</h5>
                        ...
                        <li class="d-flex mb-4 align-items-center">
                            <img src="{{ asset('images/icons/03.png') }}" alt="story-img"
                                class="rounded-pill avatar-70 p-1 border img-fluid bg-danger-subtle">
                            <div class="ms-3">
                                <h5>App Design</h5>
                        ...
                        <li class="d-flex align-items-center">
                            <img src="{{ asset('images/icons/07.png') }}" alt="story-img"
                                class="rounded-pill avatar-70 p-1 border bg-primary-subtle img-fluid">
                            <div class="ms-3">
