            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-2 col-md-6 text-center">
                            <p class="bg-dark-subtle text-white pt-5 pb-5 text-center rounded font-size-18 mt-4">Dark</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p>Contextual text classes also work well on anchors with the provided hover and focus states.
                        <strong>Note that the <code>.text-white</code> and <code>.text-muted</code> class has no
                            additional link styling beyond underline.</strong>
                    </p>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="bg-dark-subtle text-white ps-3 pe-3 pt-2 pb-2 rounded mb-0">Dark link</p>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p><a href="#" class="bg-primary-subtle ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">primary
                            link</a></p>
                    <p><a href="#"
                            class="bg-secondary-subtle ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Secondary link</a>
                    </p>
                    <p><a href="#" class="bg-success-subtle ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Success
                            link</a></p>
                    <p><a href="#" class="bg-danger-subtle ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Danger
                            link</a></p>
                    <p><a href="#" class="bg-warning-subtle ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Warning
                            link</a></p>
                    <p><a href="#" class="bg-info-subtle ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">bg-Info
                            link</a></p>
                    <p class="mb-0"><a href="#"
                            class="bg-dark-subtle text-white ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Dark link</a>
                    </p>
                </div>
            </div>
        </div>
