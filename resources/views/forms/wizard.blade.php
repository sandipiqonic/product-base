<x-app-layout :assets="$assets ?? []" title='Form Wizard' :isBanner="true" isFormWizard="true">
    <div>
        <div class="row">
                    ...
                    <form id="form-wizard1" class="mt-3 text-center">
                        ...
                        <fieldset>
                            <div class="form-card">
                                ...
                                <div class="col-3"> <img src="{{asset('images/pages/img-success.png')}}" class="img-fluid" alt="fit-image" loading="lazy"> </div>
                                </div>
                                <br><br>
                                <div class="row justify-content-center">
