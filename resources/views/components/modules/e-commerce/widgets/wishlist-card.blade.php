...
<div class="col" data-item="list">
    <div class="card flex-row">
        <div class="card-header rounded-0 rounded-start bg-light p-0">
            <img src="{{ asset('modules/e-commerce/images/') }}/{{ $images }}" class="img-fluid h-100 p-3"
                alt="wishlist-img">
        </div>
        <div class="card-body rounded-end">
            ...
            <div class="d-flex justify-content-between">
                ...
                <button class="btn btn-primary-subtle btn-icon btn-sm rounded-pill" href="javascript:void(0);"
                    data-bs-toggle="offcanvas" data-bs-target="#share-btn" aria-controls="share-btn" role="button">
                    <span class="btn-inner">
