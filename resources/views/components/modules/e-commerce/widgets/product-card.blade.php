...
<div class="card iq-product-custom-card animate:hover-media {{ $slidercard }}">
    <div class="iq-product-hover-img position-relative animate:hover-media-wrap">
        <a href="{{ route('e-commerce.product-detail') }}">
            <img src="{{ asset('modules/e-commerce/images/') }}/{{ $productimage }}" alt="product-details"
                class="iimg-fluid iq-product-img hover-media">
        </a>
        ...
        <div class="d-flex justify-content-between align-items-center mb-1">
            ...
            @if ($productrating)
                <div class="d-flex align-items-center">
                    <svg class="icon-24" xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 24 24"
                        fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
