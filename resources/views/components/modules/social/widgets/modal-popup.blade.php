        ...
        <div class="modal-body">
          <h3 class="text-center">Sign Up</h3>
            ...
            <div class="form-group me-3">
                ...
                <input type="email" class="form-control mb-0"  placeholder="Enter First Name">
            </div>
            <div class="form-group">
                <label class="form-label">Last Name</label>
                <input type="password" class="form-control mb-0" placeholder="Enter Last Name">
            </div>
            </div>
            <div class="d-flex justify-content-between">
            <div class="form-group me-3">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control mb-0" placeholder="Enter Phone Number">
            </div>
            </div>
            <div class="d-flex justify-content-between">
            <div class="form-group me-3">
                <label class="form-label">Password</label>
                <input type="email" class="form-control mb-0"  placeholder="Enter Password">
            </div>
            <div class="form-group">
