@props(['docType','docName','imgChange','imageDate','imgMb','imgName','imgLink','dropdown'])
<div class="card iq-file-manager">
    <div class="card-body card-thumbnail">
        <a href="#" data-title="{{$docType}}" data-load-file="file" data-load-target="#resolte-contaniner" data-url="{{asset('vendor/doc-viewer/include/doc-files/')}}/{{$docName}}" data-bs-toggle="modal" data-bs-target="#file-documents">
        ...
        <div class="mt-2">
            ...
            <div class="d-flex align-items-center mb-2 text-primary gap-2">
                ...
                <p class="mb-0 text-dark">{{$imgName}}</p>
            </div>
            ...
            @if($dropdown ?? '' == 'true')
                <div class="dropdown">
                    ...
                    <li><a class="dropdown-item restore-btn" href="#">Restore</a></li>
                    </ul>
                </div>
            @endif
            </div>
