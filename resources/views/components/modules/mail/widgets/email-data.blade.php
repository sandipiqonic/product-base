@props(['senderName', 'subjectName', 'emailmessage', 'mailTime', 'id', 'stars'])
<li class="iq-unread">
    <div class="d-flex align-self-center iq-unread-inner">
        <div class="iq-email-sender-info d-flex align-items-center gap-2">
            ...
            @if ($stars == 'false')
                <svg xmlns="http://www.w3.org/2000/svg" width="24" class="icon-24" viewBox="0 0 24 24" fill="none">
        ...
        <div class="card mb-0">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex justify-content-between">
                        <div class="email-remove submit me-2 text-primary">
                            <svg class="icon-24" xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 24 24"
                                fill="none">
                                <path d="M4.25 12.2743L19.25 12.2743" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M10.2998 18.2987L4.2498 12.2747L10.2998 6.24969" stroke="currentColor"
                                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                        <div class="me-2">
                            @if ($stars == 'false')
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" class="mx-2"
                            ...
                            @else
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" class="mx-2 icon-20" viewBox="0 0 20 20" fill="none">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M11.1043 2.17701L12.9317 5.82776C13.1108 6.18616 13.4565 6.43467 13.8573 6.49218L17.9453 7.08062C18.9554 7.22644 19.3573 8.45055 18.6263 9.15194L15.6702 11.9924C15.3797 12.2718 15.2474 12.6733 15.3162 13.0676L16.0138 17.0778C16.1856 18.0698 15.1298 18.8267 14.227 18.3574L10.5732 16.4627C10.215 16.2768 9.78602 16.2768 9.42679 16.4627L5.773 18.3574C4.87023 18.8267 3.81439 18.0698 3.98724 17.0778L4.68385 13.0676C4.75257 12.6733 4.62033 12.2718 4.32982 11.9924L1.37368 9.15194C0.642715 8.45055 1.04464 7.22644 2.05466 7.08062L6.14265 6.49218C6.54354 6.43467 6.89028 6.18616 7.06937 5.82776L8.89574 2.17701C9.34765 1.27433 10.6523 1.27433 11.1043 2.17701Z" stroke="#8A92A6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                            @endif
                        </div>
                ...
                <div class="d-flex justify-content-start mt-4">
                    <div>
                        <button type="button"
                            class="btn btn-gray btn-icon rounded-circle avatar-50 d-flex align-items-center justify-content-center">
                            <span>
                                <svg class="icon-24" xmlns="http://www.w3.org/2000/svg" width="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                    ...
                    <div class="ms-2">
                        <span>{{ $senderName ?? '' }}<code class="m-0 iq-word-wrap">
                                &#x3C;{{ $senderName ?? '' }}.123@gmail.com&#x3E;&#x3C;/{{ $senderName ?? '' }}.123&#x3E;</code></span><br>
                        <div class="dropdown">
                            to me
                            <svg xmlns="http://www.w3.org/2000/svg" id="dropdownMenuLink-{{ $id ?? '' }}"
                                data-bs-toggle="dropdown" aria-expanded="false" width="10" viewBox="0 0 10 6"
                                fill="none" role="button">
                                <path d="M9 1L5 5L1 1" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                            <table class="bg-white dropdown-menu p-3"
                ...
                <div>
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla egestas eu lacus, libero. Non
                        mollis nunc commodo cursus urna pharetra aliquam. Est mi diam sed ac ut id. Metus gravida enim
                        porta molestie sagittis condimentum interdum risus. Turpis porta erat mauris urna sit dapibus.
                        Auctor nibh sit magna netus vulputate enim vulputate. Purus, tortor lobortis eget fermentum.</p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla egestas eu lacus, libero. Non
                        mollis nunc commodo cursus urna pharetra aliquam. Est mi diam sed ac ut id. Metus gravida enim
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-2">
                                        ...
                                        <svg class="icon-24" xmlns="http://www.w3.org/2000/svg" width="24"
                                            ...
                                            <path d="M12.1222 15.4361L12.1222 3.39508" stroke="currentColor"
                                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M15.0382 12.5084L12.1222 15.4364L9.20621 12.5084"
                                                stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-4">
                        <img class="img-fluid w-100 rounded-1" src="{{ asset('modules/mail/images/01.png') }}"
                            alt="email-img">
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-4">
                        <img class="img-fluid w-100 rounded-1" src="{{ asset('modules/mail/images/02.png') }}"
                            alt="email-img">
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-4">
                        <img class="img-fluid w-100 rounded-1" src="{{ asset('modules/mail/images/03.png') }}"
                            alt="email-img">
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <img class="img-fluid w-100 rounded-1" src="{{ asset('modules/mail/images/01.png') }}"
