<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark iq-navbar" aria-label="Main navigation">
  <div class="container-fluid">
    <a href="{{route('dashboards')}}" class="navbar-brand d-flex align-items-center ms-0">
        <div class="logo-main">
            <div class="logo-normal text-primary">
            ...
            <div class="logo-mini text-primary">
                <svg class=" icon-30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="-0.757324" y="19.2427" width="28" height="4" rx="2" transform="rotate(-45 -0.757324 19.2427)" fill="currentColor"></rect>
                    <rect x="7.72803" y="27.728" width="28" height="4" rx="2" transform="rotate(-45 7.72803 27.728)" fill="currentColor"></rect>
                    <rect x="10.5366" y="16.3945" width="16" height="4" rx="2" transform="rotate(45 10.5366 16.3945)" fill="currentColor"></rect>
      ...
      <h4 class="logo-title text-light ms-3 mb-0" data-setting="app_name">{{env('APP_NAME')}}</h4>
    </a>
