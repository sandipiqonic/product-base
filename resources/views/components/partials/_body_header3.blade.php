<nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
    <div class="container-fluid navbar-inner">
        ...
        <a href="{{ route('dashboards') }}" class="navbar-brand col--2 col-lg-3">
            <svg width="30" class="text-primary icon-30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <ul class="navbar-nav ms-auto  navbar-list mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown" id="itemdropdown1">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="{{ route('auth.user-privacy-setting') }}">Privacy
                                Setting</a></li>
                        <li>
...
<div class="navbar dual-horizontal mx-md-auto">
    <x-partials.horizontal-nav navClass="navbar-nav"/>
</div>
