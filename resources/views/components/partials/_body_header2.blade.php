...
<nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
  <div class="container-fluid navbar-inner">
    <button data-trigger="navbar_main" class="d-xl-none btn btn-sm btn-primary btn-icon rounded-pill" type="button">
    ...
    <a href="{{route('dashboards')}}" class="logo-center navbar-brand col-md-2 col-lg-2 col-xl-2 col-xxl-3  ms-0">
      <x-logo />
      <h4 class="logo-title" data-setting="app_name">{{env('APP_NAME')}}</h4>
    </a>
    <x-partials.horizontal-nav navClass="iq-nav-menu"/>
                  ...
                  <div class="p-0 card-body max-17 scroll-thin">
                    <div class="iq-sub-card">
                        <div class="d-flex align-items-center">
                          <img class="p-1 avatar-40 rounded-pill bg-primary-subtle" src="{{asset('images/shapes/01.png')}}" alt="" loading="lazy" />
                    ...
                    <div class="iq-sub-card">
                        <div class="d-flex align-items-center">
                          <img class="p-1 avatar-40 rounded-pill bg-primary-subtle" src="{{asset('images/shapes/02.png')}}" alt="" loading="lazy" />
                          <div class="ms-3 flex-grow-1">
                    ...
                    <div class="iq-sub-card">
                        <div class="d-flex align-items-center">
                          <img class="p-1 avatar-40 rounded-pill bg-primary-subtle" src="{{asset('images/shapes/03.png')}}" alt="" loading="lazy" />
                          <div class="ms-3 flex-grow-1">
                    ...
                    <div class="iq-sub-card">
                        <div class="d-flex align-items-center">
                          <img class="p-1 avatar-40 rounded-pill bg-primary-subtle" src="{{asset('images/shapes/04.png')}}" alt="" loading="lazy" />
                          <div class="ms-3 flex-grow-1">
