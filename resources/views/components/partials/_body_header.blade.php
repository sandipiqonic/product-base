              ...
              <div class="card-body p-0">
                <a href="#" class="iq-sub-card">
                  <div class="d-flex align-items-center">
                    <img class="avatar-40 rounded-pill bg-primary-subtle p-1" src="{{asset('images/shapes/01.png')}}" alt="">
                ...
                <a href="#" class="iq-sub-card">
                  <div class="d-flex align-items-center">
                    <div class="">
                      <img class="avatar-40 rounded-pill bg-primary-subtle p-1" src="{{asset('images/shapes/02.png')}}" alt="">
                    </div>
                    <div class="ms-3 w-100">
                ...
                <a href="#" class="iq-sub-card">
                  <div class="d-flex align-items-center">
                    <img class="avatar-40 rounded-pill bg-primary-subtle p-1" src="{{asset('images/shapes/03.png')}}" alt="">
                    <div class="ms-3 w-100">
                ...
                <a href="#" class="iq-sub-card">
                  <div class="d-flex align-items-center">
                    <img class="avatar-40 rounded-pill bg-primary-subtle p-1" src="{{asset('images/shapes/04.png')}}" alt="">
            ...
            <div class="card shadow-none m-0">
              ...
              <div class="card-body p-0 ">
                ...
                <a href="#" class="iq-sub-card">
                  <div class="d-flex align-items-center">
                    <div class="">
                      <img class="avatar-40 rounded-pill bg-primary-subtle p-1" src="{{asset('images/shapes/05.png')}}" alt="">
                    </div>
                    <div class="ms-3">
