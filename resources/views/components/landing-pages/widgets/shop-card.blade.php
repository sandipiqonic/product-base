<div class="card iq-product-custom-card animate:hover-media" . $className>
    <div class="iq-product-hover-img position-relative animate:hover-media-wrap">
        <a href="{{route('landing-pages.shop-detail')}}">
            <img src="{{asset('images/landing-pages/images/' .$productImage)}}" alt="product-details"
    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-2">
            <a href="{{route('landing-pages.shop-detail')}}" class="h5 iq-product-detail mb-0">{{$productname}}</a>
            {{-- {{#if product-rating}} --}}
