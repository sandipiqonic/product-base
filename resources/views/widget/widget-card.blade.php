<x-app-layout :assets="$assets ?? []" title='Widget card' :isBanner="true" :isCircleProgress="true" isFslightbox="true">
    <div>
        <div class="row">
            <div class="col-lg-4">
                <div class="card">
                            ...
                            <div class="d-flex flex-column text-center align-items-center justify-content-between ">
                                ...
                                <div class="card-profile-progress">
                                    ...
                                    <img src="{{ asset('images/avatars/avtar_1.png') }}" alt="User-Profile"
                                        class="theme-color-purple-img img-fluid rounded-circle card-img">
                                    <img src="{{ asset('images/avatars/avtar_2.png') }}" alt="User-Profile"
                                        class="theme-color-blue-img img-fluid rounded-circle card-img">
                                    <img src="{{ asset('images/avatars/avtar_4.png') }}" alt="User-Profile"
                                        class="theme-color-green-img img-fluid rounded-circle card-img">
                                    <img src="{{ asset('images/avatars/avtar_5.png') }}" alt="User-Profile"
                                        class="theme-color-yellow-img img-fluid rounded-circle card-img">
                                    <img src="{{ asset('images/avatars/avtar_3.png') }}" alt="User-Profile"
                                        class="theme-color-pink-img img-fluid rounded-circle card-img">
                                </div>
                            ...
                            <div class="form-group mb-3">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="150"
                                        aria-label="Recipient's username" aria-describedby="basic-addon4">
                                    <span class="input-group-text" id="basic-addon44">Euro</span>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex  justify-content-start align-items-center mb-3">
                            <div class="pe-3">
                                <img src="{{ asset('images/avatars/02.png') }}"
                                    class="rounded-circle p-1 bg-danger-subtle" width="60" height="60"
                                    alt="1">
                            </div>
                            <div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-start align-items-center">
                            <div class="pe-3">
                                <img src="{{ asset('images/avatars/03.png') }}"
                                    class="rounded-circle bg-primary-subtle p-1" width="50" height="50"
                                    alt="1">
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-start align-items-center mt-4">
                            <div class="pe-3">
                                <img src="{{ asset('images/avatars/04.png') }}"
                                    class="rounded-circle bg-danger-subtle p-1" width="50" height="50"
                                    alt="1">
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-start align-items-center mt-4">
                            <div class="pe-3">
                                <img src="{{ asset('images/avatars/05.png') }}"
                                    class="rounded-circle bg-info-subtle p-1" width="50" height="50"
                                    alt="1">
                            </div>
                            <div>
                    ...
                    <div class="card-body">
                        <div class="user-post-data">
                            <div class="d-flex flex-wrap">
                                <div class="media-support-user-img me-3">
                                    <img class="rounded-circle p-1 bg-danger-subtle img-fluid avatar-60"
                        ...
                        <div class="mt-3">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor, ornare at
                                commodo non, feugiat non nisi.</p>
                        </div>
                        <div class="comment-area mt-3">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        <div class="user-img">
                                            <img src="{{ asset('images/avatars/03.png') }}" alt="userimg"
                                                class="p-1 bg-primary-subtle avatar-60 rounded-circle img-fluid">
                                        </div>
                            ...
                            <form class="form" action="#">
                                <div class="input-group mb-3">
                                    ...
                                    <button type="button" class="btn input-group-text btn-primary"
                                        id="basic-addon2">
                        ...
                        <ul class="media-story m-0 p-0">
                            <li class="d-flex mb-4 align-items-center active">
                                <img src="{{ asset('images/avatars/04.png') }}" alt="story-img"
                                    class="avatar-50 rounded-circle p-1 bg-danger-subtle img-fluid">
                            ...
                            <li class="d-flex align-items-center">
                                <img src="{{ asset('images/avatars/03.png') }}" alt="story-img"
                                    class="avatar-50 rounded-circle p-1 bg-primary-subtle img-fluid">
                                <div class="stories-data ms-3">
                                    <h5>Bob Frapples</h5>
                        ...
                        <div class="d-grid gap-card grid-cols-3">
                            <a data-fslightbox="gallery" href="{{ asset('images/icons/04.png') }}">
                                <img src="{{ asset('images/icons/04.png') }}"
                                    class="img-fluid bg-info-subtle rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" href="{{ asset('images/shapes/02.png') }}">
                                <img src="{{ asset('images/shapes/02.png') }}"
                                    class="img-fluid bg-primary-subtle rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" href="{{ asset('images/icons/08.png') }}">
                                <img src="{{ asset('images/icons/08.png') }}"
                                    class="img-fluid bg-info-subtle rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" href="{{ asset('images/shapes/04.png') }}">
                                <img src="{{ asset('images/shapes/04.png') }}"
                                    class="img-fluid bg-primary-subtle rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" href="{{ asset('images/icons/02.png') }}">
                                <img src="{{ asset('images/icons/02.png') }}"
                                    class="img-fluid bg-warning-subtle rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" href="{{ asset('images/shapes/06.png') }}">
                                <img src="{{ asset('images/shapes/06.png') }}"
                                    class="img-fluid bg-primary-subtle rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" href="{{ asset('images/icons/05.png') }}">
                                <img src="{{ asset('images/icons/05.png') }}"
                                    class="img-fluid bg-danger-subtle rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" href="{{ asset('images/shapes/04.png') }}">
                                <img src="{{ asset('images/shapes/04.png') }}"
                                    class="img-fluid bg-primary-subtle rounded" alt="profile-image">
                            ...
                            <a data-fslightbox="gallery" href="{{ asset('images/icons/01.png') }}">
                                <img src="{{ asset('images/icons/01.png') }}"
                                    class="img-fluid bg-success-subtle rounded" alt="profile-image">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="twit-feed">
                            <div class="d-flex align-items-center mb-4">
                                <img src="{{ asset('images/avatars/01.png') }}" alt="User-Profile"
                                    class="theme-color-default-img img-fluid avatar-60 me-3">
                                <img src="{{ asset('images/avatars/avtar_1.png') }}" alt="User-Profile"
                                    class="theme-color-purple-img img-fluid avatar-60 me-3">
                                <img src="{{ asset('images/avatars/avtar_2.png') }}" alt="User-Profile"
                                    class="theme-color-blue-img img-fluid avatar-60 me-3">
                                <img src="{{ asset('images/avatars/avtar_4.png') }}" alt="User-Profile"
                                    class="theme-color-green-img img-fluid avatar-60 me-3">
                                <img src="{{ asset('images/avatars/avtar_5.png') }}" alt="User-Profile"
                                    class="theme-color-yellow-img img-fluid avatar-60 me-3">
                                <img src="{{ asset('images/avatars/avtar_3.png') }}" alt="User-Profile"
                                    class="theme-color-pink-img img-fluid avatar-60 me-3">
                        ...
                        <div class="twit-feed">
                            <div class="d-flex align-items-center mb-4">
                                <img class="rounded-pill p-1 bg-primary-subtle img-fluid avatar-60 me-3"
                                    src="{{ asset('images/avatars/03.png') }}" alt="">
                                <div class="media-support-info">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-inline m-0 p-0">
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-warning-subtle rounded-pill"><img
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-danger-subtle rounded-pill"><img
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-dark-subtle rounded-pill"><img
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-primary-subtle rounded-pill"><img
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-info-subtle rounded-pill"><img
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-success-subtle rounded-pill"><img
