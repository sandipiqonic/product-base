   ...
   <div class="row">
      ...
      <div class="col-lg-12 row m-0 p-0 iq-duration-block">
         ...
         <div class="col-md-12 col-lg-4">
            <div class="card">
               <div class="card-body">
                  <h4 class="text-uppercase  mb-0">Session(Now)</h4>
                  <div class="d-flex justify-content-between align-items-center mt-2">
                     <h2 class=" ">12</h2>
                     <div class="text-left">
                        <p class="mb-1 text-uppercase">1 Hours Ago</p>
                        <div class="mb-2 ">1500<span class="text-danger">
                        ...
                        <p class="mb-1 text-uppercase">1 Day Ago</p>
                        <div class="mb-2">1890<span class="text-success">
                           <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="mb-1 text-uppercase">1 Week Ago</p>
