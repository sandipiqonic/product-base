...
if (document.querySelectorAll('#app-slider').length > 0) {
    const options = {
...
if (document.querySelectorAll('#testimonial-one-slider').length > 0) {
    const options = {
        centeredSlides: false,
        loop: false,
        slidesPerView: 4,
...
if (document.querySelectorAll('#testimonial-slider-two').length > 0) {
    const options = {
        centeredSlides: false,
        loop: false,
        slidesPerView: 4,
