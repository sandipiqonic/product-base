const iconList = [
  ...
  },
  {
    ...
    svgIcon:
     `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M14.7366 2.76181H8.08465C6.00465 2.75381 4.30065 4.41081 4.25065 6.49081V17.2278C4.20565 19.3298 5.87365 21.0698 7.97465 21.1148C8.01165 21.1148 8.04865 21.1158 8.08465 21.1148H16.0726C18.1626 21.0408 19.8146 19.3188 19.8026 17.2278V8.03781L14.7366 2.76181Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
    <path d="M14.475 2.75011V5.65911C14.475 7.07911 15.624 8.23011 17.044 8.23411H19.798" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
    <path d="M9.86387 16.2422C10.0444 16.4139 10.0444 16.6921 9.86988 16.8697C9.77964 16.9586 9.66532 17 9.54499 17C9.43068 17 9.31636 16.9586 9.23213 16.8697L7.13236 14.8153C7.04813 14.7324 7 14.6199 7 14.5015C7 14.3831 7.04813 14.2706 7.13236 14.1877L9.23213 12.1332C9.40661 11.9556 9.68939 11.9556 9.86988 12.1332C10.0444 12.3049 10.0444 12.5891 9.86387 12.7608L8.08899 14.5015L9.86387 16.2422Z" fill="currentColor"></path>
    <path fill-rule="evenodd" clip-rule="evenodd" d="M13.2446 11.1171C13.4471 11.1818 13.5622 11.3851 13.5017 11.5713L11.5298 17.64C11.4693 17.8262 11.2561 17.9248 11.0536 17.8601C10.8511 17.7954 10.736 17.5921 10.7965 17.4059L12.7684 11.3372C12.8289 11.151 13.0421 11.0524 13.2446 11.1171Z" fill="currentColor"></path>
    <path d="M14.1361 12.7578C13.9556 12.5861 13.9556 12.3079 14.1301 12.1303C14.2204 12.0414 14.3347 12 14.455 12C14.5693 12 14.6836 12.0414 14.7679 12.1303L16.8676 14.1847C16.9519 14.2676 17 14.3801 17 14.4985C17 14.6169 16.9519 14.7294 16.8676 14.8123L14.7679 16.8668C14.5934 17.0444 14.3106 17.0444 14.1301 16.8668C13.9556 16.6951 13.9556 16.4109 14.1361 16.2392L15.911 14.4985L14.1361 12.7578Z" fill="currentColor"></path>
  </svg>`
  },
  {
  ...
  },
  {
    ...
    name: "Lighting",
    svgIcon:
      `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13 10.5H16.1295L10.5 20.1505V13V12.5H10H7.5V2.5H16.191L12.5528 9.77639L12.191 10.5H13Z" stroke="currentColor"/></svg>`,
  },
  {
    id: "location-arrow",
    name: "Location Arrow",
...
function renderIcon({ id, name, svgIcon }) {
  ...
  copyButton.classList.add("btn", "btn-sm", "btn-primary-subtle");
